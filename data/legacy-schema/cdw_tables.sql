-- =============================================================================
-- LEGACY DATA WAREHOUSE SCHEMA (CDW-style) — HISTORICAL REFERENCE ONLY
-- =============================================================================
-- No longer on the runtime classpath; the application reads the normalized
-- schema in src/main/resources/schema-modern.sql. Seed data that matched this
-- DDL is preserved in cdw_seed_data.sql.
-- =============================================================================

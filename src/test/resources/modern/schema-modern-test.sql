-- TEST-ONLY H2 copy of the approved design DDL in docs/proposed-target-schema.sql.
-- Replace with src/main/resources/schema-modern.sql once Phase 2 is merged.

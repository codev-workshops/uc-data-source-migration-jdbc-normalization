 ...
 */
@Deprecated
class LoanEndpointsLegacyE2ETest extends BaseLegacyE2ETest {
  ...
  @Test
  @Sql(
      scripts = "classpath:test-data/e2e/legacy/missing-product-loan.sql",
      executionPhase = BEFORE_TEST_METHOD)
  @Sql(
      scripts = "classpath:test-data/e2e/legacy/missing-product-loan-cleanup.sql",

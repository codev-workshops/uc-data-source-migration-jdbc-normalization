...
/**
 * Reads from the legacy CDW tables and translates the cryptic, all-VARCHAR
 * legacy fields into clean DTOs. This is the original {@code LoanService} logic,
 * unchanged; it is now one of two interchangeable {@link LoanDataProvider}s.
 */
@Component
public class LegacyLoanDataProvider implements LoanDataProvider {
    ...
    public DataSourceSelector.DataSource dataSource() {
        return DataSourceSelector.DataSource.LEGACY;
    }

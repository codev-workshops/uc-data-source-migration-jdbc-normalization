...
/**
 * {@link LoanDataProvider} backed by the legacy CDW tables.
 *
 * Contains all the translation logic between legacy string-typed fields and the
 * clean DTOs (the behavior captured by the golden baseline). This is the
 * original {@code LoanService} logic, unchanged, extracted behind the provider
 * abstraction so the read source can be switched via a feature flag.
 */
@Component

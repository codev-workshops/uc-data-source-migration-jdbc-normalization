...
/**
 * Service layer that reads from modern tables via JPA relationships.
 * All legacy translation logic has been removed — the ETL migration
 * stores properly typed and expanded values in the modern schema.
 */
@Service
public class LoanService {
    ...
    private LoanSummaryDto toLoanSummary(LoanAccount acct) {
        ...
        dto.setProductDescription(product != null ? product.getName() : "Unknown");

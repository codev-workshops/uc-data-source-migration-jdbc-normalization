...
/**
 * Service layer that reads from modern normalized tables.
 * Migrated from legacy CDW schema — no more string parsing needed.
 */
@Service
...
public class LoanService {
    ...
    // =========================================================================
    // DTO MAPPING METHODS (simplified — no more string parsing)
    // =========================================================================

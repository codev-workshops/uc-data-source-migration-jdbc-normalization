...
public class LoanService {
    ...
    private LoanSummaryDto toLoanSummary(LoanAccount acct) {
        ...
        dto.setOriginalAmount(stripTrailingZerosPlain(acct.getOriginalAmount()));
        ...
        dto.setOriginationDate(acct.getOriginationDate().format(DATE_FMT));
    ...
    private PaymentDto toPaymentDto(Payment pmt) {
        ...
        dto.setPaymentDate(pmt.getPaymentDate().format(DATE_FMT));
    ...
    /**
     * Strips trailing zeros from BigDecimal while keeping plain notation.
     * Matches the behavior of the legacy parseLegacyAmount which created
     * scale-0 BigDecimals for whole numbers (e.g. "285,000" -> 285000).
     */
    private BigDecimal stripTrailingZerosPlain(BigDecimal value) {

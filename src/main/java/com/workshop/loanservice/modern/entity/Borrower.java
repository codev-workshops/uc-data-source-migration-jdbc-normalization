...
/**
 * Modern, normalized borrower record (maps to the {@code borrowers} table).
 * Properly typed: real {@link LocalDate}/{@link BigDecimal}/{@link Integer}
 * instead of the legacy all-VARCHAR representation. The legacy business key
 * {@code BORR_ID} is preserved as {@link #externalId}.
 */
@Entity

...
/**
 * Modern, normalized loan account. Borrower and product data live in their own
 * tables and are referenced by foreign key instead of being denormalized.
 * The legacy business key (CDW_LN_ACCT.LN_ACCT_NBR) is preserved in {@code accountNumber}.
 */
@Entity

...
/**
 * Modern, normalized loan account (maps to {@code loan_accounts}). Borrower and
 * product are proper foreign-key relationships instead of the legacy
 * denormalized/embedded columns. The legacy business key {@code LN_ACCT_NBR} is
 * preserved as {@link #accountNumber}.
 */
@Entity

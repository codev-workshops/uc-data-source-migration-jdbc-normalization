...
/**
 * Modern, normalized borrower entity mapping to the {@code borrowers} table
 * defined in {@code data/modern-schema/modern_tables.sql}.
 *
 * <p>Unlike the legacy {@link LegacyBorrower}, all fields use proper Java types
 * (dates, decimals, integers) instead of strings.
 */
@Entity

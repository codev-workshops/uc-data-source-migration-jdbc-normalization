 ...
 *
 * <p>Borrower details are no longer duplicated here; they are reached through
 * the {@code borrower} relationship. {@code accountNumber} carries the legacy
 * {@code CDW_LN_ACCT.LN_ACCT_NBR} natural key.
 */
@Entity

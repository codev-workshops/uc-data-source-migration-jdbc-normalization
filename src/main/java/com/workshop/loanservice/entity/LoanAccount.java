...
/**
 * Modern, normalized loan account. Maps to the {@code loan_accounts} table.
 * The legacy denormalized borrower fields are replaced by a foreign key to
 * {@link Borrower}; the legacy product code is replaced by a foreign key to
 * {@link LoanProduct}.
 */
@Entity

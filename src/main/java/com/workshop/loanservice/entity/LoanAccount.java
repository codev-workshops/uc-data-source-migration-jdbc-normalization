...
/**
 * Loan account. Borrower and product are referenced by foreign key rather than
 * denormalized into the row; {@code accountNumber} carries the legacy loan
 * account number (e.g. LN-2019-00142) exposed by the API.
 */
@Entity

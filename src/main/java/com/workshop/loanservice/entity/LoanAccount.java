...
/**
 * Modern, normalized loan account entity mapping to the {@code loan_accounts}
 * table. Borrower data is no longer denormalized here — it is referenced via a
 * {@link Borrower} foreign key. The product is referenced via {@link LoanProduct}.
 */
@Entity

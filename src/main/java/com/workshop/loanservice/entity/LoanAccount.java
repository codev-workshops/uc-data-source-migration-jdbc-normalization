...
/**
 * Maps to the modern {@code loan_accounts} table. Borrower and product data live in
 * their own tables and are reached through the foreign keys below.
 */
@Entity
...
public class LoanAccount {
    ...
    /** Business identifier exposed by the API (legacy LN_ACCT_NBR, e.g. "LN-2019-00142"). */

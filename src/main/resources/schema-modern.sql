-- =============================================================================
-- MODERN SCHEMA (Target State) — runtime DDL for the modern data source.
-- =============================================================================
-- Mirrors data/modern-schema/modern_tables.sql with two practical additions for
-- the running application:
--   1. Idempotent DROP statements so the script can be re-run safely across
--      multiple Spring (test) contexts that share the same in-memory database.
--   2. payments.external_id — preserves the legacy PMT_SEQ_NBR so the public
--      API can keep returning the original payment id after migration. (The
--      column mapping doc sanctions this: "Auto-generated; legacy ID stored if
--      needed".)
-- =============================================================================
...
CREATE TABLE payments (
    id                  BIGINT PRIMARY KEY AUTO_INCREMENT,
    external_id         VARCHAR(20),               -- preserves legacy PMT_SEQ_NBR

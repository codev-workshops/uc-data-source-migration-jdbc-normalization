...
-- =============================================================================
-- Derived from data/modern-schema/modern_tables.sql with one addition:
-- payments.external_id retains the legacy PMT_SEQ_NBR so the API can keep
...
CREATE TABLE loan_accounts (
    ...
    status              VARCHAR(15) DEFAULT 'ACTIVE',  -- ACTIVE, CLOSED, DEFAULT, FORBEARANCE
    ...
    property_type       VARCHAR(30),                   -- SINGLE_FAMILY, CONDOMINIUM, MULTI_FAMILY, TOWNHOUSE
...
CREATE TABLE payments (
    id                  BIGINT PRIMARY KEY AUTO_INCREMENT,
    external_id         VARCHAR(20) UNIQUE NOT NULL,   -- legacy payment sequence number

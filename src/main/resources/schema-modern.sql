-- =============================================================================
-- MODERN SCHEMA (runtime DDL)
-- =============================================================================
-- Mirrors data/modern-schema/modern_tables.sql, with one addition:
-- payments.external_id preserves the legacy PMT_SEQ_NBR so the public API can
-- keep exposing the same payment identifiers (see DATA_SOURCE_MIGRATION_NOTES.md).
-- =============================================================================

-- The in-memory database survives context restarts within a JVM, so make init idempotent.

-- =============================================================================
-- MODERN SCHEMA (Target State) -- H2 DDL used by the modern DataSource
-- =============================================================================
-- Mirrors data/modern-schema/modern_tables.sql with one addition required for
-- API compatibility: payments.external_id preserves the legacy PMT_SEQ_NBR so
-- the API can keep returning the original payment identifier.
-- =============================================================================

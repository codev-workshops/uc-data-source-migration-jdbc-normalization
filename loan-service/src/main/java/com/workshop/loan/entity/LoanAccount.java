package com.workshop.loan.entity;
...
/**
 * Modern, normalized loan account (table {@code loan_accounts}).
 * The legacy denormalized borrower name/SSN columns are gone: this context
 * stores only references to the other contexts — {@code borrower_id} (the
 * borrower's external id) and {@code product_code} — and resolves display
 * data via REST calls to borrower-service and product-service.
 */
@Entity

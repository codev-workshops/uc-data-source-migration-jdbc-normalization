package com.workshop.loan.dto;

import java.math.BigDecimal;

/**
 * Summary DTO for loan listing. {@code borrowerName} and {@code productDescription}
 * are enriched from borrower-service and product-service respectively.
 */
